...
import { MinigameLoading } from "./MinigameLoading";
...
export const MinigameCollectRevealModal: React.FC<Props> = ({
  ...
  return createPortal(
    <div
      ...
      className="fixed inset-0 z-[210] flex items-center justify-center p-3 pt-[max(0.5rem,env(safe-area-inset-top))] pb-[max(0.5rem,env(safe-area-inset-bottom))]"
          ...
          <div className="flex flex-col gap-3 p-1">
            {phase === "loading" && (
              <>
                ...
                <div className="flex flex-col items-center gap-2 py-4 text-sm text-[#3e2731]">
                  <MinigameLoading />
                </div>
              </>
            )}
